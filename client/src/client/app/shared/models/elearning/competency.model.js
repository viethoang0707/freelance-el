...
var Competency = (function (_super) {
    ...
    Competency.listByGroup = function (context, groupId) {
        return Competency_1.listByGroup(context, groupId);
    };
    ...
    Competency.listByGroups = function (context, groupIds) {
        ...
        return context.apiService.execute(Competency_1.__api__bulk_search(apiList), context.authService.CloudAcc.id, context.authService.CloudAcc.api_endpoint).map(function (questionArrs) {
...
//# sourceMappingURL=competency.model.js.map