...
var ExamQuestion = (function (_super) {
    ...
    ExamQuestion.__api__byQuestion = function (questionId) {
        return new search_read_api_1.SearchReadAPI(ExamQuestion_1.Model, [], "[('question_id','=','" + questionId + "')]");
    };
    ...
    ExamQuestion.populateQuestionForArray = function (context, examQuestions) {
