...
var SlideLecture = (function (_super) {
    ...
    SlideLecture.__api__byCourseUnit = function (unitId) {
        return new SlideLecture_1(SCORMLecture.Model, [], "[('unit_id','='," + unitId + ")]");
    };
    SlideLecture.byCourseUnit = function (context, unitId) {
        return SlideLecture_1.search(context, [], "[('unit_id','='," + unitId + ")]")
...
//# sourceMappingURL=lecture-slide.model.js.map