...
@Component({
	moduleId: module.id,
	selector: 'member-study-report',
	templateUrl: 'member-study-report.component.html',
	styleUrls: ['member-study-report.component.css'],
})
export class MemberStudyReportComponent extends BaseComponent {
    ...
    render(course:Course, member:CourseMember) {
		this.clear();
		this.generateReport(member);
    }

    generateReport(courses:Course, member: ){
        var apiList = [];
