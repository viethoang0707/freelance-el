            ...
            if (data["result"]) {
                _this.ngZone.run(function () {
                    if (file.name.endsWith('pdf'))
                        ...
                        _this.cloudApiService.convert2Pdf(serverFile, _this.authService.CloudAcc.id).subscribe(function (data) {
                            _this.lecture.slide_url = data["url"];
                        });
                    }
                });
...
//# sourceMappingURL=slide-lecture-unit.component.js.map