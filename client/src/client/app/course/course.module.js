    ...
    CourseModule = __decorate([
        core_1.NgModule({
            ...
            declarations: [course_component_1.CourseComponent, class_dialog_component_1.CourseClassDialog, class_list_dialog_component_1.ClassListDialog, course_pipe_1.ByCoursePipe, class_pipe_1.ByClassPipe,
                course_list_component_1.CourseListComponent, course_dialog_component_1.CourseDialog, enrollment_dialog_component_1.CourseEnrollDialog],
            exports: [course_dialog_component_1.CourseDialog],
            providers: []
        })
    ], CourseModule);
    return CourseModule;
