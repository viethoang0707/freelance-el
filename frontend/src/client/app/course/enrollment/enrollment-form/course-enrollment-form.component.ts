...
@Component({
	moduleId: module.id,
	selector: 'course-enrollment-form',
	templateUrl: 'course-enrollment-form.component.html',
})
export class CourseEnrollmentFormComponent extends BaseComponent {
	...
	loadMembers() {
		this.course.listMembers(this, MEMBER_FIELDS).subscribe(members => {
