...
var ReportComponent = (function (_super) {
    ...
    ReportComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
            selector: 'report',
            template: "<div class=\"card card-w-title\">   <h1>{{'Reports'|translate}}</h1>   <div class=\"ui-g\">      <div class=\"ui-g-12\">       <p-dropdown [options]=\"items\" [(ngModel)]=\"selectedItem\" placeholder=\"{{'Select a report'| translate}}\" (onChange)=\"selectReport()\" styleClass=\"report-items\"></p-dropdown>     </div>     <div class=\"ui-g-12\">       <ng-template report-container></ng-template>     </div>   </div> </div>",
            styles: [""],
        }),
